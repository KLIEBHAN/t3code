    ...
    execute: (row) =>
      sql`
        ...
        DO UPDATE SET
          ...
          checkpoint_unified_diff = excluded.checkpoint_unified_diff
      `,
  });
    ...
    execute: ({ threadId }) =>
      sql`
        SELECT
          ...
          checkpoint_unified_diff AS "checkpointUnifiedDiff"
        FROM projection_turns
        WHERE thread_id = ${threadId}
        ORDER BY
          CASE
