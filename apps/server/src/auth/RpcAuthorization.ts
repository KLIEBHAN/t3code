...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.suggestionsGenerateReplySuggestions]: AuthOrchestrationOperateScope,
  [WS_METHODS.promptAutocompleteGenerate]: AuthOrchestrationOperateScope,
  [WS_METHODS.promptImprovementGenerate]: AuthOrchestrationOperateScope,
