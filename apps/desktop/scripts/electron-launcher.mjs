...
function buildMacLauncher(electronBinaryPath) {
  ...
  // ditto preserves relative symlinks inside macOS .app bundles; fs.cpSync rewrites them to
  // absolute paths, which breaks Electron helper resource lookup (e.g. icudtl.dat).
